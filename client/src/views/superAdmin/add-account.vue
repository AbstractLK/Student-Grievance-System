    ...
    <v-card>
        <v-sheet max-width="800px" class="mx-auto">
            <v-tabs v-model="tab" color="deep-purple-accent-4" fixed-tabs>
                <v-tab value="one">Department Admin</v-tab>
                <v-tab value="two">Faculty Admin</v-tab>
                <v-tab value="three">University Admin</v-tab>
            </v-tabs>
        </v-sheet>
                ...
                <v-window-item value="two">
                    ...
                    <v-container>
                        ...
                        <v-card-actions>
                            ...
                            <v-btn @click="callRestAPI('facultyAdmin')" color="success">
                            Complete Registration
                    ...
                    <v-card elevation="5" rounded="lg" class="mx-auto px-10 pt-5" max-width="480">
                        ...
                        <v-container>
                            ...
                            <v-card-actions>
                                ...
                                <v-btn @click="callRestAPI('universityAdmin')" color="success">
                                Complete Registration
